...
class ShopwareProductionProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '2c196f41e87f9dc9e1b4e81c185bc539'), array('hashed_directory_perm' => 493, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = $this->get('db_factory')->factory('pdo_mysql', array('username' => 'shopware', 'password' => 'Be2paeQuie6uith3piew3au7o4th1shu9ETgeixeiJ', 'dbname' => 'shopware', 'host' => '192.168.0.112', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/doctrine/attributes', 'proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), $this->get('hooks'));
    }
    protected function getModelsService()
    {
        ...
        return $this->services['models'] = $this->get('model_factory')->factory($a, $this->get('modelconfig'), $this->get('loader'), $this->get('db_connection'), '/var/www/html/app.sdoering.syseleven.de', $this->get('modelannotations'));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/var/www/html/app.sdoering.syseleven.de', $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    ...
    {
        return $this->services['shopware_plugininstaller.plugin_manager'] = new \Shopware\Bundle\PluginInstallerBundle\Service\InstallerService($this->get('models'), $this->get('plugins'), '/var/www/html/app.sdoering.syseleven.de');
    }
    ...
    {
        return $this->services['template'] = $this->get('template_factory')->factory($this->get('events'), new \Enlight_Components_Snippet_Resource($this->get('snippets'), false), $this->get('shopware.escaper'), array('compileCheck' => true, 'compileLocking' => true, 'useSubDirs' => true, 'forceCompile' => false, 'useIncludePath' => true, 'charset' => 'utf-8', 'forceCache' => false, 'cacheDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/templates', 'compileDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/templates'));
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/var/www/html/app.sdoering.syseleven.de', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/var/www/html/app.sdoering.syseleven.de', $this->get('template'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943',
            ...
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/templates',
                'compileDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/templates',
            ),
            ...
            'shopware.template.cachedir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/templates',
            'shopware.template.compiledir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '2c196f41e87f9dc9e1b4e81c185bc539',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '2c196f41e87f9dc9e1b4e81c185bc539',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/doctrine/attributes',
                'proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/doctrine/attributes',
            'shopware.model.proxydir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201605230943/doctrine/proxies',
