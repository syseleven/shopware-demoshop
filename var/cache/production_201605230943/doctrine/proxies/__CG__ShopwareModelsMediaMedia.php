...
class Media extends \Shopware\Models\Media\Media implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getHighDpiThumbnails()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHighDpiThumbnails', array());
    ...
    public function loadThumbnails($highDpi = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'loadThumbnails', array($highDpi));
