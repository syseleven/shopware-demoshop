...
class ShopwareProductionda39a3ee5e6b4b0d3255bfef95601890afd80709ProjectContainer extends Shopware\Components\DependencyInjection\Container
{
    ...
    {
        return $this->services['cache'] = $this->get('cache_factory')->factory('auto', array('automatic_serialization' => true, 'automatic_cleaning_factor' => 0, 'lifetime' => 3600, 'cache_id_prefix' => '6c5d4b9d15c318f063ec9259d3674d4a'), array('hashed_directory_perm' => 493, 'cache_file_perm' => 420, 'hashed_directory_level' => 3, 'cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/general', 'file_name_prefix' => 'shopware'));
    }
    ...
    {
        return $this->services['db'] = \Shopware\Components\DependencyInjection\Bridge\Db::createEnlightDbAdapter($this->get('dbal_connection'), array('username' => 'shopware', 'password' => 'Be2paeQuie6uith3piew3au7o4th1shu9ETgeixeiJ', 'dbname' => 'shopware', 'host' => '192.168.0.112', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'));
    }
    ...
    {
        return $this->services['dbal_connection'] = \Shopware\Components\DependencyInjection\Bridge\Db::createDbalConnection(array('username' => 'shopware', 'password' => 'Be2paeQuie6uith3piew3au7o4th1shu9ETgeixeiJ', 'dbname' => 'shopware', 'host' => '192.168.0.112', 'charset' => 'utf8', 'adapter' => 'pdo_mysql', 'port' => '3306'), $this->get('modelconfig'), $this->get('model_event_manager'), $this->get('db_connection'));
    }
    ...
    {
        return $this->services['hooks'] = new \Enlight_Hook_HookManager($this->get('events'), $this->get('loader'), array('proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/proxies', 'proxyNamespace' => 'Shopware_Proxies'));
    }
    ...
    {
        return $this->services['modelannotations'] = $this->get('model_annotations_factory')->factory($this->get('modelconfig'), '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Models');
    }
    protected function getModelconfigService()
    {
        return $this->services['modelconfig'] = new \Shopware\Components\Model\Configuration(array('autoGenerateProxyClasses' => false, 'attributeDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/doctrine/attributes', 'proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/doctrine/proxies', 'proxyNamespace' => 'Shopware\\Proxies', 'cacheProvider' => 'auto', 'cacheNamespace' => NULL), $this->get('cache'), new \Shopware\Components\Model\ProxyAwareRepositoryFactory($this->get('hooks')));
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/app.sdoering.syseleven.de/var/log/core_production.log', 14);
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler('/var/www/html/app.sdoering.syseleven.de/var/log/plugin_production.log', 14);
        $a->pushProcessor($this->get('monolog.processor.uid'));
    ...
    {
        return $this->services['plugins'] = $this->get('plugins_factory')->factory($this, $this->get('loader'), $this->get('events'), $this->get('application'), array('Default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/'));
    }
    ...
    {
        return $this->services['shopware.openssl_verificator'] = new \Shopware\Components\OpenSSLVerifier('/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Components/HttpClient/public.key');
    }
    ...
    {
        return $this->services['shopware.snippet_database_handler'] = new \Shopware\Components\Snippet\DatabaseHandler($this->get('models'), $this->get('db'), '/var/www/html/app.sdoering.syseleven.de');
    }
    protected function getShopware_SnippetQueryHandlerService()
    {
        return $this->services['shopware.snippet_query_handler'] = new \Shopware\Components\Snippet\QueryHandler('/var/www/html/app.sdoering.syseleven.de/snippets/');
    }
    ...
    {
        return $this->services['shopware_plugininstaller.legacy_plugin_installer'] = new \Shopware\Bundle\PluginInstallerBundle\Service\LegacyPluginInstaller($this->get('models'), $this->get('plugins'), array('Default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/'));
    }
    protected function getShopwarePlugininstaller_PluginDownloadServiceService()
    {
        return $this->services['shopware_plugininstaller.plugin_download_service'] = new \Shopware\Bundle\PluginInstallerBundle\Service\DownloadService('/var/www/html/app.sdoering.syseleven.de', array('Default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/'), $this->get('shopware_plugininstaller.store_client'), $this->get('dbal_connection'));
    }
    ...
    {
        return $this->services['snippets'] = new \Shopware_Components_Snippet_Manager($this->get('models'), array('Default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/'), array('readFromDb' => true, 'writeToDb' => true, 'readFromIni' => false, 'writeToIni' => false, 'showSnippetPlaceholder' => false));
    }
    protected function getTemplateService()
    {
        return $this->services['template'] = $this->get('template_factory')->factory($this->get('events'), new \Enlight_Components_Snippet_Resource($this->get('snippets'), false), $this->get('shopware.escaper'), array('compileCheck' => true, 'compileLocking' => true, 'useSubDirs' => true, 'forceCompile' => false, 'useIncludePath' => true, 'charset' => 'utf-8', 'forceCache' => false, 'cacheDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/templates', 'compileDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/templates'));
    }
    ...
    {
        return $this->services['theme_compiler'] = new \Shopware\Components\Theme\Compiler('/var/www/html/app.sdoering.syseleven.de', $this->get('oyejorge_compiler'), $this->get('theme_path_resolver'), $this->get('theme_inheritance'), $this->get('theme_service'), $this->get('js_compressor'), $this->get('events'), $this->get('theme_timestamp_persistor'));
    }
    ...
    {
        return $this->services['theme_path_resolver'] = new \Shopware\Components\Theme\PathResolver('/var/www/html/app.sdoering.syseleven.de', array('Default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/', 'Local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/', 'Community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/'), $this->get('template'));
    }
    ...
    {
        return $this->services['thumbnail_manager'] = new \Shopware\Components\Thumbnail\Manager($this->get('thumbnail_generator_basic'), '/var/www/html/app.sdoering.syseleven.de', $this->get('events'), $this->get('shopware_media.media_service'));
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/var/www/html/app.sdoering.syseleven.de',
            'kernel.environment' => 'production',
            'kernel.debug' => false,
            'kernel.name' => 'Shopware',
            'kernel.cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359',
            'kernel.logs_dir' => '/var/www/html/app.sdoering.syseleven.de/var/log',
            ...
            'shopware.cdn' => array(
                ...
                'adapters' => array(
                    'local' => array(
                        ...
                        'path' => '/var/www/html/app.sdoering.syseleven.de',
                    ),
                    'ftp' => array(
                        'type' => 'ftp',
                        'mediaUrl' => '',
            ...
            'shopware.cdn.adapters.local.path' => '/var/www/html/app.sdoering.syseleven.de',
            ...
            'shopware.db' => array(
                'username' => 'shopware',
                'password' => 'Be2paeQuie6uith3piew3au7o4th1shu9ETgeixeiJ',
                'dbname' => 'shopware',
                'host' => '192.168.0.112',
                'charset' => 'utf8',
                'adapter' => 'pdo_mysql',
            ...
            'shopware.db.password' => 'Be2paeQuie6uith3piew3au7o4th1shu9ETgeixeiJ',
            'shopware.db.dbname' => 'shopware',
            'shopware.db.host' => '192.168.0.112',
            ...
            'shopware.plugin_directories' => array(
                'Default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/',
                'Local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/',
                'Community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/',
            ),
            'shopware.plugin_directories.default' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Default/',
            'shopware.plugin_directories.local' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Local/',
            'shopware.plugin_directories.community' => '/var/www/html/app.sdoering.syseleven.de/engine/Shopware/Plugins/Community/',
            'shopware.template' => array(
                ...
                'charset' => 'utf-8',
                'forceCache' => false,
                'cacheDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/templates',
                'compileDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/templates',
            ),
            ...
            'shopware.template.cachedir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/templates',
            'shopware.template.compiledir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/templates',
            'shopware.mail' => array(
                'charset' => 'utf-8',
            ),
            ...
            'shopware.httpcache' => array(
                ...
                'cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/html',
                'cache_cookies' => array(
                    0 => 'shop',
                    1 => 'currency',
            ...
            'shopware.httpcache.cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/html',
            ...
            'shopware.cache' => array(
                'frontendOptions' => array(
                    ...
                    'lifetime' => 3600,
                    'cache_id_prefix' => '6c5d4b9d15c318f063ec9259d3674d4a',
                ),
                'backend' => 'auto',
                'backendOptions' => array(
                    ...
                    'cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/general',
            ...
            'shopware.cache.frontendoptions.cache_id_prefix' => '6c5d4b9d15c318f063ec9259d3674d4a',
            ...
            'shopware.cache.backendoptions.cache_dir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/general',
            'shopware.cache.backendoptions.file_name_prefix' => 'shopware',
            'shopware.hook' => array(
                'proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/proxies',
                'proxyNamespace' => 'Shopware_Proxies',
            ),
            'shopware.hook.proxydir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/proxies',
            'shopware.hook.proxynamespace' => 'Shopware_Proxies',
            'shopware.model' => array(
                'autoGenerateProxyClasses' => false,
                'attributeDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/doctrine/attributes',
                'proxyDir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/doctrine/proxies',
                'proxyNamespace' => 'Shopware\\Proxies',
                'cacheProvider' => 'auto',
                'cacheNamespace' => NULL,
            ),
            'shopware.model.autogenerateproxyclasses' => false,
            'shopware.model.attributedir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/doctrine/attributes',
            'shopware.model.proxydir' => '/var/www/html/app.sdoering.syseleven.de/var/cache/production_201607251359/doctrine/proxies',
